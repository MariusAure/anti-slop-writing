...
- **Hard bans**. This is puffery, symbolism without evidence, brochure tone, triad padding, synonym stuffing, engagement-bait openers, copula avoidance, trailing -ing phrases, vague attributions, and model-specific tells for both Claude and ChatGPT.
- **Required behaviors**. Use mechanism verbs, add checkable details to claims, prefer concrete over abstract, use "is" and "are" freely.
